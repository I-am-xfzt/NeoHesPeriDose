...
NeoHesPeriDose 是一个现代化的前后端分离 Web 应用项目，专为作者集成工具库设计。项目采用 Vue3 + TypeScript 前端技术栈，配合 Koa.js 后端服务，引入了智谱AI聊天服务，并集成了多种3D引擎（Three.js、Babylon.js、Cesium）。
...
- 🌐 **3D引擎集成**: 集成 Three.js、Babylon.js 和 Cesium 三大3D引擎
- 🤖 **AI聊天服务**: 集成 AI 对话功能
...
- **事件总线**: mitt
- **UI库**: Element Plus
- **3D引擎**: Three.js, Babylon.js, Cesium
- **富文本编辑器**: WangEditor
- **国际化**: vue-i18n
